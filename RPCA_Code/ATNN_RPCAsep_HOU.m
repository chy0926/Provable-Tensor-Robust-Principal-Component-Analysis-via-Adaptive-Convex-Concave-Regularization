%% ========================================================================
% Main solver for AC^2-TRPCA
%
% This file implements the proposed Adaptive Convex-Concave Tensor Robust
% Principal Component Analysis (AC^2-TRPCA) method described in the paper:
%
% "Provable Tensor Robust Principal Component Analysis via
%  Adaptive Convex-Concave Regularization"
% Main function:
%   [X, E, iter] = ATNN_RPCAsep_HOU(Ten, opts)
%
% X    - recovered low-rank tensor
% E    - estimated sparse component
